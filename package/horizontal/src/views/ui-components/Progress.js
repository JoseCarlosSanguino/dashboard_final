  ...
  return (
    <div>
      ...
      <Card>
        ...
        <CardBody className="">
          <div className="text-center mb-3"> 0 % </div> <Progress />
          <div className="text-center mb-3"> 25 % </div> <Progress value="25" />
          <div className="text-center mb-3"> 50 % </div> <Progress value={50} />
          <div className="text-center mb-3"> 75 % </div> <Progress value={75} />
